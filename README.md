...
# DELL XPS 15 9570 Ubuntu post installation script (18.04 and 20.04)
...
Collection of scripts and tweaks to make Ubuntu 18.04/20.04 run smooth on Dell XPS 15 9570.
...
```shell
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Bjew87/dell-xps-9570-ubuntu-respin/master/xps-tweaks.sh)"
```
